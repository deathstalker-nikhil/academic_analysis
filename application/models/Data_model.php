...
class Data_model extends CI_Model {
	...
	{
			$sql = "SELECT AVG(scores.external) AS externalAverage, AVG(scores.attendance) AS attendanceAverage from scores join students on students.id = scores.student_id where scores.subject_id = $subject GROUP BY students.batch";
		$query = $this->db->query($sql);
	return $query->result_array();
	}
