...
$route['choose_subject_batch_for_analysis'] = 'Home/choose_subject_batch_for_analysis';
...
$route['score_prediction_extra_curricular/(:num)'] = 'Home/score_prediction_extra_curricular/$1';
